export interface Province { name: string; cities: string[]; }

// Full mainland prefecture-level coverage, plus Hong Kong, Macao and Taiwan.
export const PROVINCES: Province[] = [
  { name: "北京", cities: ["北京市"] }, { name: "天津", cities: ["天津市"] }, { name: "上海", cities: ["上海市"] }, { name: "重庆", cities: ["重庆市"] },
  { name: "河北", cities: ["石家庄", "唐山", "邯郸", "邢台", "保定", "张家口", "承德", "沧州", "廊坊", "衡水"] },
  ...
  { name: "新疆", cities: ["乌鲁木齐", "克拉玛依", "吐鲁番", "哈密", "昌吉", "博尔塔拉", "巴音郭楞", "阿克苏", "克孜勒苏", "喀什", "和田", "伊犁", "塔城", "阿勒泰", "石河子", "阿拉尔", "图木舒克", "五家渠", "北屯", "铁门关", "双河", "可克达拉", "昆玉", "胡杨河", "新星"] },
  { name: "香港", cities: ["香港"] }, { name: "澳门", cities: ["澳门"] }, { name: "台湾", cities: ["台北", "新北", "桃园", "台中", "台南", "高雄", "基隆", "新竹", "嘉义", "宜兰", "花莲", "台东"] },
];

export const ALL_CITIES: string[] = PROVINCES.flatMap((province) => province.cities);
